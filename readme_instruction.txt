...
9) At the prompt, type "python manage.py migrate". This would create some predefined admin apps that are very 
10) At the prompt(in dir mysite), type "django-admin startapp notes". Make appropriate changes to notes/urls.py 
and notes/views.py 
11) At the prompt(in dir mysite), type "django-admin startapp blog". Make appropriate changes to blog/urls.py 
and blog/views.py
